...
struct _default_entries_data entries_data[] = {
	...
	{GNOME_STOCK_BUTTON_NEXT, GNOME_STOCK_PIXMAP_REGULAR, N_("Help"), imlib_right_arrow, TIGERT_W, TIGERT_H, TB_W, TB_H},
	{GNOME_STOCK_BUTTON_PREV, GNOME_STOCK_PIXMAP_REGULAR, N_("Help"), imlib_left_arrow, TIGERT_W, TIGERT_H, TB_W, TB_H},
